...
class PathsModel(pydantic.BaseModel):
    ...
    @pydantic.validator('annotation_file', 'pdf_folder', 'processed_output', pre=True)
...
File: C:\Users\aezak\Desktop\desktop folder\swe\invtx_hackathon_folder\invtx-hackathon\preprocess_data.py
```python
...
File: C:\Users\aezak\Desktop\desktop folder\swe\invtx_hackathon_folder\invtx-hackathon\utils.py
```python
import argparse
from pathlib import Path
import yaml
